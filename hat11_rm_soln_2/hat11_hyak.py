...
from friedrich.lightcurve import (LightCurve, hat11_params_morris_rm_soln_2,
                                  generate_lc_depth)
...
if os.path.exists('/Users/bmmorris/data/hat11/'):
    ...
    output_dir = os.path.abspath('/gscratch/stf/bmmorris/friedrich/hat11_rm_soln_2')
...
depth = 0.00343
hat11_params = hat11_params_morris_rm_soln_2()
